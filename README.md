...
| **Anything else pi can address** | local MLX / llama.cpp / LM Studio weights; bundled `local-duo` uses `omlx/Qwen3.6-35B-A3B-UD-MLX-3bit` plus `omlx/Qwen3.8-9B-heretic-uncensored-5bit-MLX` | 35B for dispatcher/recon/verdicts; 9B for docs, deps, conventions, extractors |
