// Daemon-level tests for .pi/agent-fleet/scripts/coms-hermes-bridge.ts. These use temp
...
const BRIDGE = ".pi/agent-fleet/scripts/coms-hermes-bridge.ts";
const CLI = ".pi/agent-fleet/scripts/coms-cli.ts";
