...
test("justfile exposes one Fleet entry point while hidden runtime recipes forward arguments", () => {
	...
	for (const command of [
		".pi/agent-fleet/scripts/team-up.ts --team {{team}} {{args}}",
		".pi/agent-fleet/scripts/team-up.ts --team {{team}} --hub {{args}}",
		".pi/agent-fleet/scripts/team-up.ts --team {{team}} --conductor {{args}}",
		".pi/agent-fleet/scripts/team-up.ts --team {{team}} --conductor --dry-run {{args}}",
		".pi/agent-fleet/scripts/team-snapshot.ts snapshot {{team}} {{args}}",
		".pi/agent-fleet/scripts/team-snapshot.ts down {{team}} {{args}}",
		".pi/agent-fleet/scripts/team-snapshot.ts resume {{team}} {{args}}",
	]) {
