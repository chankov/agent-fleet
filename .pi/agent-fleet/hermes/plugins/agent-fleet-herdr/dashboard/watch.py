...
# reaches argv. Mirrors HERMES_PROFILE_RE in .pi/agent-fleet/scripts/coms-hermes-bridge.ts.
...
class HermesSink:
    ...
    Spawned exactly as .pi/agent-fleet/scripts/coms-hermes-bridge.ts spawns it — no shell, and
