...
> In a Fleet session the `compact-and-continue` pi extension performs the mechanical half of this automatically. It does not decide *what* is worth keeping — the judgement below still belongs to the agent.
