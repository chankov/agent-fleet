...
# (`hookWatchDir` in .pi/agent-fleet/scripts/coms-claude-bridge.ts). Copied rather than derived:
...
def bridge_hook_path(pane_id: str, root: Path | None = None) -> Path | None:
    ...
    .pi/agent-fleet/scripts/coms-claude-bridge.ts sanitises it — copied rather than derived,
