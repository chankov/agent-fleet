...
Run: python3 .pi/agent-fleet/hermes/plugins/agent-fleet-herdr/dashboard/coms-registry.test.py
"""
...
# fixture is the contract check against .pi/agent-fleet/scripts/lib/coms-envelope.ts.
ENTRY = {
