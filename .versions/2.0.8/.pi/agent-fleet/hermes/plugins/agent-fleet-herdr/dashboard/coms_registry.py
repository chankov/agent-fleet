...
Read-only by construction. `pruneDeadEntries()` in .pi/agent-fleet/scripts/lib/coms-envelope.ts
...
# Mirrors REGISTRY_HEARTBEAT_FRESH_MS in .pi/agent-fleet/scripts/lib/coms-envelope.ts:25, and
