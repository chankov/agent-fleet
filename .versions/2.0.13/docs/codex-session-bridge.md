...
```sh
node .pi/agent-fleet/scripts/fleet-codex-client.ts doctor
node .pi/agent-fleet/scripts/fleet-codex-client.ts sessions --project af
node .pi/agent-fleet/scripts/fleet-codex-client.ts select --project af --peer orchestrator
node .pi/agent-fleet/scripts/fleet-codex-client.ts status
node .pi/agent-fleet/scripts/fleet-codex-client.ts summary
node .pi/agent-fleet/scripts/fleet-codex-client.ts send --id task-001 --text-file /private/tmp/instruction.txt --wait-ms 1000
node .pi/agent-fleet/scripts/fleet-codex-client.ts watch --seconds 30
node .pi/agent-fleet/scripts/fleet-codex-client.ts resync
node .pi/agent-fleet/scripts/fleet-codex-client.ts replay
node .pi/agent-fleet/scripts/fleet-codex-client.ts receipts
node .pi/agent-fleet/scripts/fleet-codex-client.ts detach
```
...
```sh
node .pi/agent-fleet/scripts/fleet-codex-client.ts --help
node .pi/agent-fleet/scripts/fleet-codex-client.ts describe
```
...
```sh
node .pi/agent-fleet/scripts/fleet-codex-client.ts questions
node .pi/agent-fleet/scripts/fleet-codex-client.ts questions --after <nextCursor>
node .pi/agent-fleet/scripts/fleet-codex-client.ts answer --id answer-001 --question <question-id> --answer-file /private/tmp/answer.json
node .pi/agent-fleet/scripts/fleet-codex-client.ts cancel-question --id cancel-001 --question <question-id>
node .pi/agent-fleet/scripts/fleet-codex-client.ts receipts
```
