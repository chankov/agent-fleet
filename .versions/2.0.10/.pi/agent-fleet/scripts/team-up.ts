...
//   parsing/validation/layout logic lives in .pi/agent-fleet/scripts/lib/herdr-layout.ts.
...
// Pre-warm/stagger (see .pi/agent-fleet/scripts/lib/spawn-stagger.ts): when auth.json holds a
