...
- `/af-coms` — open the coms control surface; `--project <name>` retargets the pool (use `*` for
...
`coms_list` tool cannot widen scope; only `/af-coms --project` / `/af-coms --all` can. This prevents an
