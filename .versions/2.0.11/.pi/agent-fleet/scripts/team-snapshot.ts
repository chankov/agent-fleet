// .pi/agent-fleet/scripts/team-snapshot.ts
//
...
// .pi/agent-fleet/scripts/lib/team-snapshot.ts; entrypoint-guarded like team-up.
...
async function cmdResume(team: string, project = DEFAULT_PROJECT): Promise<void> {
	...
	// pre-warm/stagger as team-up (see .pi/agent-fleet/scripts/lib/spawn-stagger.ts).
